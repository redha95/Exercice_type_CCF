...
public class ServiceREST {
	...
	private void peuplementListe() {
		...
		try {
				...
				for(Utilisateur iter : resultat){
					listeDTO.getListedto().add(new UtilisateurDTO(iter.getNom(),iter.getPrenom(),iter.getEmail(),iter.getPassword(),iter.getRole().getRole()));
				}
